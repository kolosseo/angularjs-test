...
'use strict';
    ...
    function ShoppingListComponentController($element) {
        ...
        // $doCheck was introduced since v1.5.8 and
        // it's very useful, 'cause avoid to create new watchers,
        // (like in the previous example "angular_v1.5.7")
        // leaving the app to run faster.
